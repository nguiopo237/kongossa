 ...
 static String generateRandomString(int length) {
  ...
  Future<void> addComments(videoId) async {
    ...
    try {
      ...
      if (!snapshot.exists) {
        debugPrint("❌ Document does not exist: ${videoId}");
        await postRef.set({
          'postData': {
            'commentaire': [],
            'persolike': [],
      ...
      debugPrint("✅ Comment added with ID: $uniqueId");
      _commentController.clear();

    } catch (e) {
      debugPrint('❌ Error: $e');
      Get.snackbar('app.error'.tr, 'comments.error'.tr);
    }
  }
