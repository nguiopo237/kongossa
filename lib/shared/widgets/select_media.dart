...
import '../../sevice/upload/upload.dart';
...
class PremiumMediaSelector extends StatefulWidget {
  ...
  const PremiumMediaSelector({
    ...
    this.title = 'media.add_photo',
    this.description = 'media.choose_source',
  });
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 16,
                              color: ColorApp.primary3.withValues(alpha: 0.7),
                              height: 1.5,
                            ),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _buildSourceCard(
                          ...
                          title: 'media.gallery'.tr,
                          subtitle: 'media.choose_image'.tr,
                          color: Colors.purple,
                          gradient: LinearGradient(
                            colors: [
        ...
        onTap: () async {
          ...
          if (pickedFile != null) {
            updateimage() async {
              ...
              debugPrint(originalName);
              debugPrint(pickedFile.path);
              debugPrint("pickedFile.path 1");
              ...
              if (url != null) {
                debugPrint("pickedFile.path 2");
                debugPrint(url);
                debugPrint("pickedFile.path 2");
                QuerySnapshot querySnapshot = await FirestoreCollectionsService.users.where(
                  'googleId',
                  isEqualTo: AppUser.info?.googleId,
                ).get();
                FirestoreCollectionsService.users.doc(
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: isHovered
                            ...
                            : ColorApp.primary3.withValues(alpha: 0.6),
                        height: 1.4,
                      ),
                      textAlign: TextAlign.center,
                    ),
